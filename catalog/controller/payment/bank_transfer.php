...
class ControllerPaymentBankTransfer extends Controller {
	...
	public function confirm() {
		...
		$comment .= "<hr>";
		$comment .= "Bank Organisation Name: " . $this->request->post['bank_name'] . "\n\n";
		$comment .= "Account Name: " . $this->request->post['account_name'] . "\n\n";
		$comment .= "Account Type: " . $this->request->post['account_type'] . "\n\n";
		$comment .= "Account Number: " . $this->request->post['account_number'] . "\n\n";

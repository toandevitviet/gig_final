...
class ModelCatalogProduct extends Model {
	...
	public function getGifts($data = array()) {
		$sql ="SELECT  *  FROM " . DB_PREFIX ."cardgift INNER JOIN " . DB_PREFIX . "cardgift_description    ON " . DB_PREFIX ."cardgift.cardgift_id = ". DB_PREFIX . "cardgift_description.cardgift_id WHERE " . DB_PREFIX ."cardgift.status = '1' order by cardgift.sort_order";
		$query = $this->db->query($sql);
		return $query->rows;
	}

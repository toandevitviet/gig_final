...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($random['image']) {
			$thumb = $this->model_tool_image->resize($random['image'], 270, 264);
		} else {
			$thumb = '';
		}
		...
		//cho '<pre>'; var_dump($this->data['randomproduct']);die;
		...
		//echo '<pre>'; var_dump($categories_custom);die;
            ...
            $this->data['image_product_popup'] = $product_info['image'];
            ...
            $this->data['image_product'] = $product_info['image'];
